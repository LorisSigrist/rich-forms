...
describe("parsePath", () => {
    ...
    it("should parse a path with a dot and a bracket and a dot", () => {
        expect(parsePath("hello.world[0].test")).toEqual(["hello", "world", "0", "test"]);
    });

    it("should parse a path with a dot and a bracket and a dot and a bracket", () => {
        expect(parsePath("hello.world[0].test[0]")).toEqual(["hello", "world", "0", "test", "0"]);
    });

    it("should parse a path with multiple dots", () => {
        expect(parsePath("hello.world[0].test.test")).toEqual(["hello", "world", "0", "test", "test"]);
    })
